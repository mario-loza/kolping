...
$sql="SELECT * FROM evaluacioncurricula WHERE Cargo LIKE '%$nombrecargo%' and Nom_Postulante LIKE '%$nombrepostulante%'";
//echo $sql;
$res=mysql_query($sql);
?>
	<table>
...
while($reg=mysql_fetch_array($res)){
    ...
    <tr class="contenido">
		...
		*/?>
        <td><a href="reporte.php?cod=<?php echo $reg['CodEvaluacionCurricula']?>" class="reporte">Reporte</a></td>
    </tr>
    <?php	
}
?>
