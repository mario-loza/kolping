...
.content ul, .content ol { 
	padding: 0 10px 10px 30px; /* este relleno reproduce en espejo el relleno derecho de la regla de encabezados y de párrafo incluida más arriba. El relleno se ha colocado en la parte inferior para que el espacio existente entre otros elementos de la lista y a la izquierda cree la sangría. Estos pueden ajustarse como se desee. */
}
...
<div class="container">
  <div class="header"><!-- end .header -->
    <form id="form1" name="form1" method="post" action="">
      <p><img src="logo_kolping_infopunkt.jpg" width="293" height="282" /></p>
      <p>&nbsp;</p>
    </form>
    <p>&nbsp;</p>
  </div>
